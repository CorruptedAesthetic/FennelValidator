# General Cloud Validator Setup Guide

**86x_general_step_by_step_guide.md** — Deploy a Fennel Solonet validator on any major cloud provider (AWS, GCP, Azure, Oracle Cloud, DigitalOcean, etc.)
