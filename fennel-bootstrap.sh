...
if [ $PLAYBOOK_EXIT_CODE -eq 0 ]; then
    ...
    print_info "1. Note the session key bundle displayed above"
    print_info "2. Create your stash account and note the SS58 address"
    print_info "3. Send both to Fennel Labs for validator registration"
    echo
